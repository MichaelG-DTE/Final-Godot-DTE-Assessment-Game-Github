...
#when the player collides with the object, it adds two to the health, 
#and checks whether the GlobalVariable is below the max of 20. If it is 20, it does not add to the shield health
