...
var boss_laser = preload("res://Scenes/Boss_Scenes/boss_laser.tscn")
var boss_missile = preload("res://Scenes/Boss_Scenes/boss_missile_2.tscn")
var boss_shield = preload("res://Scenes/Boss_Scenes/boss_shield.tscn")
...
#after the boss depletes both health bars, the boss plays his death animation
...
#the player dies if it tries to fly into the boss
