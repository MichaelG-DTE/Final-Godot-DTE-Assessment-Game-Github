...
#instantiates the lasers in the level
...
#after the boss is killed, the victory cutscene and music plays, then the credits cutscene and music after that
